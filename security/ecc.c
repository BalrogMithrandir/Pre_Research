...
void Get_B_X_Y(mp_int *x1,mp_int *y1,mp_int *b, mp_int *a, mp_int *p)
{
    ...
    while(1)
    {
        //4a3+27b2≠0 (mod p)
        GetPrime(b,40);
        mp_expt_d(a, 3, &temp1);  /*temp1 = a^3*/
        mp_sqr(b, &temp2);  /*temp2 = b^2*/
        mp_mul_d(&temp1, 4, &temp3);  /*temp3 = 4*a^3*/
        mp_mul_d(&temp2, 27, &temp4);  /*temp4 = 27*b^2*/
